        ...
        <>
            <div className={ `skel-pro skel-detail ${ adClass }` }></div>
            {
                ...
                <div className={ `product-single-details ${ adClass }` }>
                    ...
                    {
                        product.variants.length > 0 ?
                            <div className="product-filters-container pb-0 pt-0">
                                {
...

                                {
                                    attrs.sizes.length > 0 ?
                                        <div className="product-single-filter pt-0">
                                            <label>Size:</label>
                    ...
                    <div className="product-info-box pt-4">
                        <div className="product-info-date">
                            <span className="product-info-name">Release date:</span>
                            <span className="product-info">{ product.release_date }</span>
                        </div>

                        <div className="product-info-developer">
                            <span className="product-info-name">Developer:</span>
                            <span className="product-info">{ product.developer }</span>
                        </div>

                        <div className="product-info-publisher">
                            <span className="product-info-name">Publisher:</span>
                            <span className="product-info">{ product.publisher }</span>
                        </div>

                        <div className="product-info-gamemode">
                            <span className="product-info-name">Game Mode:</span>
                            <span className="product-info">{ product.game_mode }</span>
                        </div>

                        <div className="product-info-rate">
                            <span className="product-info-name">Rated:</span>
                            <span className="product-info-ratenum">{ product.rated }</span>
                            <span className="product-info">not recommended for people under { product.rated }</span>
                        </div>
                    </div>

                    <ul className="single-info-list mt-0">
                        {
                            product.sku ?
                                <li>
