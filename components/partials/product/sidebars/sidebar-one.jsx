            ...
            <aside className={ `sidebar-product col-lg-3 mobile-sidebar skeleton-body skel-shop-products ${ adClass } ${ loading ? '' : 'loaded' }` }>
                <StickyBox className="sticky-wrapper" offsetTop={ 90 }>
                                    ...
                                    { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <>
                                            <h3 className="widget-title">
                                                <a href="#" className="text-white" onClick={ ( e ) => { e.preventDefault(), onToggle() } } className={ toggleState === 'COLLAPSED' ? 'collapsed' : '' }>Categories</a>
                                            </h3>
                    ...
                    <div className="widget widget-featured">
                        <h3 className="widget-title text-white">Featured</h3>
