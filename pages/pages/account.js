                        ...
                        <div className="col-lg-9 order-lg-last order-1 tab-content">
                            <TabPanel className="tab-pane fade" id="dashboard">
                                <div className="dashboard-content">
                                    <p>
                                        Hello <strong className="text-primary">Editor</strong> (not <strong className="text-primary">Editor</strong>? <ALink href="/pages/login" className="btn btn-link ">Log out</ALink>)
                                    </p>
                                        ...
                                        <div className="row">
                                            <div className="address col-md-6">
                                                <div className="heading d-flex">
                                                    <h4 className="text-primary mb-0">Billing address</h4>
                                                </div>
