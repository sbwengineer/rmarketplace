...
function ProductStickyBoth () {
    ...
    return (
        <main className="main">
            <div className="container">
                <nav aria-label="breadcrumb" className="breadcrumb-nav">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item"><ALink href="/shop">Games</ALink></li>
            ...
            <SingleTabFive product={ product } isCustom={ false } adClass={ `custom-product-single-tabs pt-2 mb-0 bg-transparent mt-lg-6 mt-2 pb-3 skeleton-body skel-shop-products ${ loading ? '' : 'loaded' }` } />

            <div className="product-both-info-bottom">
                <div className="container">
